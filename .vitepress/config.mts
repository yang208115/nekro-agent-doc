              ...
              items: [
                ...
                { text: "快速上手", link: "/docs/04_plugin_dev/01_quick_start" },
                {
                  ...
                  items: [
                    ...
                    { text: "异步任务工具", link: "/docs/04_plugin_dev/02_plugin_basics/2.5_async_tasks" },
              ...
              items: [
                ...
                { text: "Quick Start", link: "/en/docs/04_plugin_dev/01_quick_start" },
                {
                  ...
                  items: [
                    ...
                    { text: "Async Tasks Tool", link: "/en/docs/04_plugin_dev/02_plugin_basics/2.5_async_tasks" },
              ...
              items: [
                ...
                { text: "クイックスタート", link: "/ja/docs/04_plugin_dev/01_quick_start" },
                {
                  ...
                  items: [
                    ...
                    { text: "非同期タスクツール", link: "/ja/docs/04_plugin_dev/02_plugin_basics/2.5_async_tasks" },
